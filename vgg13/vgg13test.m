...
net = importONNXNetwork('../../Pruned/l1-norm/vgg13/vgg13.onnx','OutputLayerType','classification');
netP = importONNXNetwork('../../Pruned/l1-norm/vgg13/vgg13pruned.onnx','OutputLayerType','classification');
% Test the networks
addpath('../../datasets');
acc = testCifar10(net);
...
save('vgg13nnv.mat','nn');
save('vgg13nnv_pruned.mat','nnP');