...
net = importONNXNetwork('../../Pruned/l1-norm/vgg16/vgg16.onnx','OutputLayerType','classification');
netP = importONNXNetwork('../../Pruned/l1-norm/vgg16/vgg16pruned.onnx','OutputLayerType','classification');
% Test the networks
addpath('../../datasets');
acc = testCifar10(net);
...
% save('vgg16nnv.mat','nn');
% save('vgg16nnv_pruned.mat','nnP');