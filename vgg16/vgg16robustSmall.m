...
% Load images
% n = 100; % Number of images to test (ideally n/10 of each class)
n = 10; %(Show in video)
...
class_nn = zeros(1,n); % classification labels for the unpruned network
class_nnP = zeros(1,n); % classification labels for the pruned network
for i=1:n
...
%% Evaluate robustness
% n2 = 100; % Number of attacked images to verify (paper)
n2 = 10; % To show in video
