...
net = importONNXNetwork('../../Pruned/l1-norm/vgg11/vgg11.onnx','OutputLayerType','classification');
netP = importONNXNetwork('../../Pruned/l1-norm/vgg11/vgg11pruned.onnx','OutputLayerType','classification');
% Test the networks
addpath('../../datasets');
acc = testCifar10(net);
...
save('vgg11nnv.mat','nn');
save('vgg11nnv_pruned.mat','nnP');